...
public class frmModificar_Cliente extends JDialog {
	public frmModificar_Cliente() {
	}
    ...
    private ArregloClientes listClient;
    ...
    public EditClient() {
        ...
        Cliente editClient = globalContext.getEditClient();
        ...
        buttonOK.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               ArregloClientes.editClient(code,nameClientEdit,ageClientEdit,cityClientEdit);
